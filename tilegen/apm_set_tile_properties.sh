...
bosh int products/$tilegenName/$productVersion/product.yml \
    -o products/$tilegenName/$productVersion/network/3-az-configuration.yml \
...
bosh int \\
    $productName.yml \\
    -l ../../../../tilegen/products/$tilegenName/$productVersion/errand-vars.yml \\
    -l ../../../../tilegen/products/$tilegenName/$productVersion/resource-vars.yml \\
    -l ../../../../tilegen/products/$tilegenName/$productVersion/product-default-vars.yml \\
